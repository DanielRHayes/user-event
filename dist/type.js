...
async function typeImpl(element, text, {
  ...
  const currentElement = () => ignoreActiveElement === true ? element : (0, _utils.getActiveElement)(element.ownerDocument); // by default, a new element has it's selection start and end at 0
